...
function EditUserName () {
    ...
    //Récupération du profil utilisateur et le token de Redux state
    ...
    const handleSubmit = (e) => {
        ...
        if (!newUserName) {
            setError("Un nom d'utilisateur est attendue")
            return;
        }
        ...
        //Envoie de l'action redux thunk pour mettre à jour le nom d'utilisateur
